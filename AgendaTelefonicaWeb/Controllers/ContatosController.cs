...
namespace AgendaTelefonicaWeb.Controllers
{
    public class ContatosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Numero")] Contato contato)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Numero")] Contato contato)
        {
            if (id != contato.Id)
            {
                return NotFound();
